...
export const mapsAPI = {
  ...
  explain:       (concept, parentTopic)    => api.post("/maps/explain", { concept, parentTopic }),
  quiz:          (concepts, parentTopic)   => api.post("/maps/quiz", { concepts, parentTopic }),
  getAll:        ()                        => api.get("/maps"),
  ...
  saveNote:      (id, nodeId, note)        => api.patch(`/maps/${id}/notes`, { nodeId, note }),
